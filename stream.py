...
class App(customtkinter.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.radiobutton_normal.grid(row=1, column=0, padx=10, pady=20, sticky="e")
        self.radiobutton_canny.grid(row=1, column=1, padx=10, pady=20, sticky="w")

        self.slider_threshold1 = customtkinter.CTkSlider(
            master=self,
            from_=0,
            to=255,
            number_of_steps=255,
        )
        self.slider_threshold2 = customtkinter.CTkSlider(
            master=self,
            from_=0,
            to=255,
            number_of_steps=255,
        ...
        self.slider_threshold1.grid(
            row=2, column=0, columnspan=2, padx=10, pady=20, sticky="ew"
        )
        self.slider_threshold2.grid(
            row=3, column=0, columnspan=2, padx=10, pady=20, sticky="ew"
        )

        # initializing sliders to default values
        self.slider_threshold1.set(100)
        self.slider_threshold2.set(200)
    ...
    def check_queue(self):
        ...
        try:
            ...
            if self._current_mode == MODE_CANNY:
                ...
                frame_processed = cv2.Canny(
                    frame_gray,
                    threshold1=self.slider_threshold1.get(),
                    threshold2=self.slider_threshold2.get(),
                )
